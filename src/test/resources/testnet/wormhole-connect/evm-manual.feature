...
#      | manual | 0.001  | WBNB  | Base Goerli     | Arbitrum Goerli | MetaMask    | MetaMask  | BaseScan                 | Arbitrum Goerli Explorer |
...
#      | manual | 0.001  | DAI   | Goerli          | Mumbai          | MetaMask    | MetaMask  | Etherscan                | Polygonscan              |
